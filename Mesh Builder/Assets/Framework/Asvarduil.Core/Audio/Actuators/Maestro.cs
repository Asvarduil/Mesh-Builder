...
public class Maestro : DebuggableBehavior
{
    ...
    {
        AudioClip clip = AudioManager.GetAudioByPath(audioPath);
        PlayBGM(clip);
    }
    ...
    public void PlayOneShot(string soundPath, float? effectVolume = null)
    {
        AudioClip clip = AudioManager.GetAudioByPath(soundPath);
        PlayOneShot(clip, effectVolume);
    }
    ...
    public void ChangeTunes(string soundPath)
    {
        AudioClip clip = AudioManager.GetAudioByPath(soundPath);
        ChangeTunes(clip);
    }
    ...
    public void InterjectTune(string soundPath, float switchTime = 0.1f)
    {
        AudioClip clip = AudioManager.GetAudioByPath(soundPath);
        InterjectTune(clip, switchTime);
    }
