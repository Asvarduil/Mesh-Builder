...
public class VoxelChunk : MonoBehaviour
{
    ...
    public VoxelWorldPosition WorldPosition;

    public VoxelBlock[,,] _blocks = new VoxelBlock[chunkSize, chunkSize, chunkSize];
    ...
    {
        foreach (VoxelBlock block in Blocks)
        {
    ...
    private void RenderMesh(VoxelMeshData meshData)
    {
        Filter.mesh.Clear();
